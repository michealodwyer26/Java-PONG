...
public class MainGameScreen implements Screen {
	...
	public MainGameScreen(PongGame game) {
		...
		font = new BitmapFont(Gdx.files.internal("data/MediumFont/MediumEmulogic.fnt"), false);
		divider = new Texture(Gdx.files.internal("data/divider.png"));
		// Sounds
		pointLossSound = Gdx.audio.newSound(Gdx.files.internal("data/audio1.wav"));
		pointWonSound = Gdx.audio.newSound(Gdx.files.internal("data/point_sound.wav"));
